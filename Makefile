...
pkgdatadir = $(datadir)/wxMozBrowser
pkglibdir = $(libdir)/wxMozBrowser
pkgincludedir = $(includedir)/wxMozBrowser
top_builddir = .

ACLOCAL = ${SHELL} /home/jmccarth/test/wxmoz2/missing --run aclocal-1.6
AUTOCONF = ${SHELL} /home/jmccarth/test/wxmoz2/missing --run autoconf
AUTOMAKE = ${SHELL} /home/jmccarth/test/wxmoz2/missing --run automake-1.6
AUTOHEADER = ${SHELL} /home/jmccarth/test/wxmoz2/missing --run autoheader
...
OBJEXT = o
PATH_SEPARATOR = :
AMTAR = ${SHELL} /home/jmccarth/test/wxmoz2/missing --run tar
AS = @AS@
AWK = gawk
CC = gcc
CXX = g++
...
am__include = include
am__quote = 
install_sh = /home/jmccarth/test/wxmoz2/install-sh
SUBDIRS = src demo include
subdir = .
